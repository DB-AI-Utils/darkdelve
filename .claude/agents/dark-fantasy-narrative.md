...
tools: Read, NotebookEdit, WebFetch, TodoWrite, WebSearch, Skill, MCPSearch, mcp__codex__codex, mcp__codex__codex-reply, mcp__sequential-thinking__sequentialthinking, Write
model: opus
color: green
---
